...
<div id="countdownBanner-<?php echo e($uniqueId = uniqid()); ?>"
    class="countdown-banner bg-[#1E3A8A] items-center py-2 w-full font-inter gap-3 relative" 
    data-deadline="<?php echo e($deadline); ?>"
    data-title="<?php echo e($title); ?>" 
    data-show="<?php echo e($show ? 'true' : 'false'); ?>"
    data-schedule-info="<?php echo e(json_encode($scheduleInfo)); ?>">
    ...
    <div class="flex items-center justify-center w-full px-4 md:px-6 py-1">
        ...
        <div class="schedule-dots-vertical hidden md:flex flex-col items-center justify-center gap-2 mr-4 md:mr-6">
            <?php $__currentLoopData = $scheduleInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button class="schedule-dot-vertical w-2 h-2 rounded-full bg-blue-300/30 transition-all duration-300 <?php echo e($index === 0 ? 'bg-blue-300 h-2' : ''); ?>"
                        data-index="<?php echo e($index); ?>" 
                        title="<?php echo e($info); ?>">
                </button>
        ...
        <div class="flex justify-center items-center gap-1 md:gap-6 w-full">
            <div class="flex justify-center items-center  gap-10">
                ...
                <div class="text-center md:text-center w-full md:w-auto order-1 relative overflow-hidden">
                    ...
                    <div id="scheduleSlider-<?php echo e($uniqueId); ?>"
                        ...
                        <div class="schedule-items-vertical transition-transform duration-500 ease-in-out">
                            <?php $__currentLoopData = $scheduleInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="schedule-item-vertical absolute w-full text-base md:text-lg font-medium text-white leading-tight md:whitespace-nowrap transition-opacity duration-500"
                                    data-index="<?php echo e($index); ?>"
                                    style="transform: translateY(<?php echo e($index * 100); ?>%); opacity: <?php echo e($index === 0 ? '1' : '0'); ?>;">
                                    <?php echo e($info); ?>
                    ...
                    <div class="flex justify-center gap-2">
                        ...
                        <div class="text-center">
                            <div class="px-2 md:px-3 min-w-10 md:min-w-12.5">
                                <span id="days-<?php echo e($uniqueId); ?>" class="text-[24px] font-bold text-white">00</span>
                            </div>
                        ...
                        <div class="text-center">
                            <div class="px-2 md:px-3 min-w-10 md:min-w-12.5">
                                <span id="hours-<?php echo e($uniqueId); ?>" class="text-[24px] font-bold text-white">00</span>
                            </div>
                        ...
                        <div class="text-center">
                            <div class="px-2 md:px-3 min-w-10 md:min-w-12.5">
                                <span id="minutes-<?php echo e($uniqueId); ?>" class="text-[24px] font-bold text-white">00</span>
                            </div>
                        ...
                        <div class="text-center">
                            <div class="px-2 md:px-3 min-w-10 md:min-w-12.5">
                                <span id="seconds-<?php echo e($uniqueId); ?>" class="text-[24px] font-bold text-white">00</span>
                            </div>
                ...
                <div class="w-full md:w-auto shrink-0 order-2 md:order-3 flex items-center gap-2">
                    <button id="inputBtn-<?php echo e($uniqueId); ?>"
                ...
                <button id="closeBtn-<?php echo e($uniqueId); ?>"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        initializeCountdownBanner('<?php echo e($uniqueId); ?>');
        initializeVerticalScheduleSlider('<?php echo e($uniqueId); ?>');
    });
...
</script><?php /**PATH C:\Users\alfak\Herd\emonev\resources\views/components/countdown-banner.blade.php ENDPATH**/ ?>